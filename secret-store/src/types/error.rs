...
pub enum Error {
	...
	/// The joint signature key `traits::JOINT_SIGNATURE_KEY_ID` is not found
	SigningKeyIsNotFound,
...
impl fmt::Display for Error {
	fn fmt(&self, f: &mut fmt::Formatter) -> Result<(), fmt::Error> {
		match *self {
			...
			Error::SigningKeyIsNotFound => write!(f, "joint signature key has not been generated"),
		}
	}
}
